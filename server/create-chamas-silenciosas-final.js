...
async function createChamasSilenciosasFinal() {
  try {
    ...
    const grimoireData = {
      ...
      content: 'Grimório final sobre o chamado ancestral que ressoa através do silêncio',
      is_paid: true,
      price: '39.99',
      level: 'avançado',
      unlock_order: 6,
    ...
    // Capítulos com linguagem mística, densa e sutilmente ameaçadora
    const chapters = [
      {
    ...
    console.log('🔥 Grimório "CHAMAS SILENCIOSAS" criado com sucesso!');
    ...
    console.log('🔥 ATRIUM IGNIS COMPLETADO - Série preparatória finalizada!');
